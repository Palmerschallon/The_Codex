    ...
    genre_configs = {
        ...
        'noir': {
            ...
            'phrases': [
                ...
                "Secrets hide in every shadow...",
                "The clock ticks. Waiting...",
            ]
        },
        'mystery': {
        ...
        'western': {
            ...
            'empty': '─', 'filled': '═',
            'phrases': [
                "Dust settles on the horizon...",
                "The sun beats down...",
                "A tumbleweed rolls past...",
                "Spurs jingle in the distance...",
        ...
        'scifi': {
            ...
            'empty': '▱', 'filled': '▰',
            'phrases': [
                "Quantum calculations processing...",
                "Scanning dimensional variance...",
                "Neural pathways synchronizing...",
                "Stellar coordinates aligned...",
        ...
        'cyberpunk': {
            ...
            'phrases': [
                ...
                "ICE protocols detected...",
                "Neural link established...",
                "Data streams converging...",
                "Chrome dreams loading...",
            ]
        },
        'adventure': {
            'color': '\033[36m',  # cyan
        ...
        'comedy': {
            ...
            'phrases': [
                ...
                "Comedic timing loading...",
                "Preparing the unexpected...",
            ]
        },
    }

    # Find matching genre config
    genre_lower = genre.lower()
    config = genre_configs['adventure']  # default
    for key in genre_configs:
        if key in genre_lower:
            config = genre_configs[key]
            break
